...
from noco_db_python_sdk.model.base_get_shared_base_response import BaseGetSharedBaseResponse as BaseGetSharedBaseResponseSchema

from noco_db_python_sdk.type.id import Id
from noco_db_python_sdk.type.base_get_shared_base_response import BaseGetSharedBaseResponse
...
from noco_db_python_sdk.pydantic.base_get_shared_base_response import BaseGetSharedBaseResponse as BaseGetSharedBaseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseGetSharedBaseResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseGetSharedBaseResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_shared_base_mapped_args(
        self,
        base_id: Id,
    ...
    async def _aget_shared_base_oapg(
        self,
...
class GetSharedBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_shared_base(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_shared_base_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._aget_shared_base_oapg(
    ...
    def get_shared_base(
        ...
        return self._get_shared_base_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetSharedBase(BaseApi):
    ...
    async def aget_shared_base(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseGetSharedBaseResponsePydantic:
        raw_response = await self.raw.aget_shared_base(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return BaseGetSharedBaseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BaseGetSharedBaseResponsePydantic, raw_response.body)
    ...
    def get_shared_base(
        ...
        raw_response = self.raw.get_shared_base(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
