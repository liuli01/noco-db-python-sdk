...
from noco_db_python_sdk.model.gallery_update_req import GalleryUpdateReq as GalleryUpdateReqSchema

from noco_db_python_sdk.type.meta import Meta
from noco_db_python_sdk.type.gallery_update_req import GalleryUpdateReq
...
from noco_db_python_sdk.pydantic.gallery_update_req import GalleryUpdateReq as GalleryUpdateReqPydantic
...
# Path params
GalleryViewIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'galleryViewId': typing.Union[GalleryViewIdSchema, str, ],
    }
)
...
request_path_gallery_view_id = api_client.PathParameter(
    name="galleryViewId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=GalleryViewIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = GalleryUpdateReqSchema


request_body_gallery_update_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_gallery_view_data_mapped_args(
        self,
        gallery_view_id: str,
        ...
        if gallery_view_id is not None:
            _path_params["galleryViewId"] = gallery_view_id
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aupdate_gallery_view_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/galleries/{galleryViewId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_gallery_update_req.serialize(body, content_type)
    ...
    def _update_gallery_view_data_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateGalleryViewDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_gallery_view_data(
        self,
        gallery_view_id: str,
        fk_cover_image_col_id: typing.Optional[StringOrNull] = None,
        meta: typing.Optional[Meta] = None,
        ...
        **kwargs,
        ...
        args = self._update_gallery_view_data_mapped_args(
            gallery_view_id=gallery_view_id,
            fk_cover_image_col_id=fk_cover_image_col_id,
            meta=meta,
            xc_auth=xc_auth,
        )
        return await self._aupdate_gallery_view_data_oapg(
            body=args.body,
    ...
    def update_gallery_view_data(
        ...
        return self._update_gallery_view_data_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateGalleryViewData(BaseApi):
    ...
    async def aupdate_gallery_view_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_gallery_view_data(
            gallery_view_id=gallery_view_id,
            fk_cover_image_col_id=fk_cover_image_col_id,
            meta=meta,
            xc_auth=xc_auth,
    ...
    def update_gallery_view_data(
        ...
        raw_response = self.raw.update_gallery_view_data(
            gallery_view_id=gallery_view_id,
            fk_cover_image_col_id=fk_cover_image_col_id,
            meta=meta,
            xc_auth=xc_auth,
