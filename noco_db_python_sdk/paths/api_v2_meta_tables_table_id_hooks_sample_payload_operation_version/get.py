...
from noco_db_python_sdk.model.db_table_webhook_get_sample_payload_response import DbTableWebhookGetSamplePayloadResponse as DbTableWebhookGetSamplePayloadResponseSchema
...
from noco_db_python_sdk.type.db_table_webhook_get_sample_payload_response import DbTableWebhookGetSamplePayloadResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.db_table_webhook_get_sample_payload_response import DbTableWebhookGetSamplePayloadResponse as DbTableWebhookGetSamplePayloadResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'operation': typing.Union[OperationSchema, str, ],
...
request_path_operation = api_client.PathParameter(
    name="operation",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = DbTableWebhookGetSamplePayloadResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DbTableWebhookGetSamplePayloadResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_sample_payload_mapped_args(
        self,
        table_id: Id,
        operation: str,
        version: str,
    ...
    async def _aget_sample_payload_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/tables/{tableId}/hooks/samplePayload/{operation}/{version}',
            headers=_headers,
        )
...
class GetSamplePayloadRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sample_payload(
        self,
        table_id: Id,
        operation: str,
        version: str,
        ...
        **kwargs,
        ...
        args = self._get_sample_payload_mapped_args(
            table_id=table_id,
            operation=operation,
            version=version,
            xc_auth=xc_auth,
        )
        return await self._aget_sample_payload_oapg(
    ...
    def get_sample_payload(
        ...
        return self._get_sample_payload_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetSamplePayload(BaseApi):
    ...
    async def aget_sample_payload(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DbTableWebhookGetSamplePayloadResponsePydantic:
        raw_response = await self.raw.aget_sample_payload(
            table_id=table_id,
            operation=operation,
            version=version,
            xc_auth=xc_auth,
        ...
        if validate:
            return DbTableWebhookGetSamplePayloadResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DbTableWebhookGetSamplePayloadResponsePydantic, raw_response.body)
    ...
    def get_sample_payload(
        ...
        raw_response = self.raw.get_sample_payload(
            table_id=table_id,
            operation=operation,
            version=version,
            xc_auth=xc_auth,
