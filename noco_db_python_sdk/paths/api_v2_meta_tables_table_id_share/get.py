...
class BaseApi(api_client.Api):
    ...
    def _list_shared_views_mapped_args(
        self,
        table_id: Id,
    ...
    async def _alist_shared_views_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/tables/{tableId}/share',
            headers=_headers,
        )
...
class ListSharedViewsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_shared_views(
        self,
        table_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_shared_views_mapped_args(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        return await self._alist_shared_views_oapg(
    ...
    def list_shared_views(
        ...
        return self._list_shared_views_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListSharedViews(BaseApi):
    ...
    async def alist_shared_views(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_shared_views(
            table_id=table_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def list_shared_views(
        ...
        raw_response = self.raw.list_shared_views(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        if validate:
