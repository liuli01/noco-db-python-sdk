...
from noco_db_python_sdk.model.grid_update_req import GridUpdateReq as GridUpdateReqSchema
...
from noco_db_python_sdk.type.grid_update_req import GridUpdateReq
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.grid_update_req import GridUpdateReq as GridUpdateReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GridUpdateReqSchema


request_body_grid_update_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_grid_view_mapped_args(
        self,
        view_id: str,
        row_height: typing.Optional[typing.Union[int, float]] = None,
    ...
    async def _aupdate_grid_view_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/grids/{viewId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_grid_update_req.serialize(body, content_type)
...
class UpdateGridViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_grid_view(
        self,
        view_id: str,
        row_height: typing.Optional[typing.Union[int, float]] = None,
        meta: typing.Optional[Meta] = None,
        ...
        **kwargs,
        ...
        args = self._update_grid_view_mapped_args(
            view_id=view_id,
            row_height=row_height,
            meta=meta,
            xc_auth=xc_auth,
        )
        return await self._aupdate_grid_view_oapg(
            body=args.body,
    ...
    def update_grid_view(
        ...
        return self._update_grid_view_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateGridView(BaseApi):
    ...
    async def aupdate_grid_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_grid_view(
            view_id=view_id,
            row_height=row_height,
            meta=meta,
            xc_auth=xc_auth,
    ...
    def update_grid_view(
        ...
        raw_response = self.raw.update_grid_view(
            view_id=view_id,
            row_height=row_height,
            meta=meta,
            xc_auth=xc_auth,
