...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'pks': typing.Union[PksSchema, str, ],
    },
    total=False
)
...
request_query_pks = api_client.QueryParameter(
    name="pks",
    style=api_client.ParameterStyle.FORM,
    schema=PksSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    ...
    def _list_shared_rows_mapped_args(
        self,
    ...
    async def _alist_shared_rows_oapg(
        self,
...
class ListSharedRowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_shared_rows(
        self,
        shared_view_uuid: str,
        xc_password: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_shared_rows_mapped_args(
        ...
        return await self._alist_shared_rows_oapg(
    ...
    def list_shared_rows(
        ...
        return self._list_shared_rows_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ListSharedRows(BaseApi):
    ...
    async def alist_shared_rows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_shared_rows(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            fields=fields,
            sort=sort,
    ...
    def list_shared_rows(
        ...
        raw_response = self.raw.list_shared_rows(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            fields=fields,
            sort=sort,
