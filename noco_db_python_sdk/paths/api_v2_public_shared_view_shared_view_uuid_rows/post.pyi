...
from noco_db_python_sdk.model.public_create_shared_view_row_response import PublicCreateSharedViewRowResponse as PublicCreateSharedViewRowResponseSchema
...
from noco_db_python_sdk.type.public_create_shared_view_row_response import PublicCreateSharedViewRowResponse
...
from noco_db_python_sdk.pydantic.public_create_shared_view_row_response import PublicCreateSharedViewRowResponse as PublicCreateSharedViewRowResponsePydantic
...
# body param
SchemaForRequestBodyMultipartFormData = schemas.AnyTypeSchema
...
SchemaFor200ResponseBodyApplicationJson = PublicCreateSharedViewRowResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PublicCreateSharedViewRowResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_shared_view_row_mapped_args(
        self,
    ...
    async def _acreate_shared_view_row_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public/shared-view/{sharedViewUuid}/rows',
            body=body,
            headers=_headers,
        )
    ...
    def _create_shared_view_row_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateSharedViewRowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_shared_view_row(
        self,
        shared_view_uuid: str,
        xc_password: typing.Optional[str] = None,
        body: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        **kwargs,
        ...
        args = self._create_shared_view_row_mapped_args(
            body=body,
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
        )
        return await self._acreate_shared_view_row_oapg(
            body=args.body,
    ...
    def create_shared_view_row(
        ...
        return self._create_shared_view_row_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateSharedViewRow(BaseApi):
    ...
    async def acreate_shared_view_row(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicCreateSharedViewRowResponsePydantic:
        raw_response = await self.raw.acreate_shared_view_row(
            body=body,
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            **kwargs,
        ...
        if validate:
            return PublicCreateSharedViewRowResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PublicCreateSharedViewRowResponsePydantic, raw_response.body)
    ...
    def create_shared_view_row(
        ...
        raw_response = self.raw.create_shared_view_row(
            body=body,
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
        )
