...
from noco_db_python_sdk.model.view_column_req import ViewColumnReq as ViewColumnReqSchema
...
from noco_db_python_sdk.type.view_column_req import ViewColumnReq
...
from noco_db_python_sdk.pydantic.view_column_req import ViewColumnReq as ViewColumnReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ViewColumnReqSchema


request_body_view_column_req = api_client.RequestBody(
    content={
    ...
    async def _acreate_new_column_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}/columns',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_view_column_req.serialize(body, content_type)
