...
from noco_db_python_sdk.model.column_list import ColumnList as ColumnListSchema
...
from noco_db_python_sdk.type.column_list import ColumnList
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.column_list import ColumnList as ColumnListPydantic
...
SchemaFor200ResponseBodyApplicationJson = ColumnListSchema
...
class ListByViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_view(
        self,
        view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_by_view_mapped_args(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        return await self._alist_by_view_oapg(
    ...
    def list_by_view(
        ...
        return self._list_by_view_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListByView(BaseApi):
    ...
    async def alist_by_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_by_view(
            view_id=view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return ColumnListPydantic(**raw_response.body)
        return api_client.construct_model_instance(ColumnListPydantic, raw_response.body)
    ...
    def list_by_view(
        ...
        raw_response = self.raw.list_by_view(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        if validate:
