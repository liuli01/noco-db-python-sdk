...
class BaseApi(api_client.Api):
    ...
    def _clear_noco_cache_mapped_args(
        self,
    ...
    async def _aclear_noco_cache_oapg(
        self,
...
class ClearNocoCacheRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aclear_noco_cache(
        self,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._clear_noco_cache_mapped_args(
            xc_auth=xc_auth,
        )
        return await self._aclear_noco_cache_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def clear_noco_cache(
        self,
        xc_auth: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._clear_noco_cache_oapg(
            header_params=args.header,
        )

class ClearNocoCache(BaseApi):
    ...
    async def aclear_noco_cache(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aclear_noco_cache(
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
    ...
    def clear_noco_cache(
        ...
        raw_response = self.raw.clear_noco_cache(
            xc_auth=xc_auth,
        )
        if validate:
            return RootModel[bool](raw_response.body).root
