...
class BaseApi(api_client.Api):
    ...
    def _get_view_data_mapped_args(
        self,
        view_id: str,
    ...
    async def _aget_view_data_oapg(
        self,
...
class GetViewDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_view_data(
        self,
        view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_view_data_mapped_args(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        return await self._aget_view_data_oapg(
    ...
    def get_view_data(
        ...
        return self._get_view_data_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetViewData(BaseApi):
    ...
    async def aget_view_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_view_data(
            view_id=view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def get_view_data(
        ...
        raw_response = self.raw.get_view_data(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        if validate:
