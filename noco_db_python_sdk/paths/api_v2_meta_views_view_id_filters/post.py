...
class BaseApi(api_client.Api):
    ...
    def _create_view_filter_mapped_args(
        self,
        view_id: str,
    ...
    async def _acreate_view_filter_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}/filters',
            body=body,
            headers=_headers,
        )
...
class CreateViewFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_view_filter(
        self,
        view_id: str,
        comparison_op: typing.Optional[typing.Optional[str]] = None,
        comparison_sub_op: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._create_view_filter_mapped_args(
            view_id=view_id,
        ...
        return await self._acreate_view_filter_oapg(
            body=args.body,
    ...
    def create_view_filter(
        ...
        return self._create_view_filter_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateViewFilter(BaseApi):
    ...
    async def acreate_view_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_view_filter(
            view_id=view_id,
            comparison_op=comparison_op,
            comparison_sub_op=comparison_sub_op,
            fk_column_id=fk_column_id,
    ...
    def create_view_filter(
        ...
        raw_response = self.raw.create_view_filter(
            view_id=view_id,
            comparison_op=comparison_op,
            comparison_sub_op=comparison_sub_op,
            fk_column_id=fk_column_id,
