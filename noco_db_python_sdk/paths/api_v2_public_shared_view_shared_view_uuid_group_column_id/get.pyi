...
from noco_db_python_sdk.model.public_shared_view_group_data_list_response import PublicSharedViewGroupDataListResponse as PublicSharedViewGroupDataListResponseSchema
from noco_db_python_sdk.model.id import Id as IdSchema

from noco_db_python_sdk.type.id import Id
from noco_db_python_sdk.type.public_shared_view_group_data_list_response import PublicSharedViewGroupDataListResponse
...
from noco_db_python_sdk.pydantic.public_shared_view_group_data_list_response import PublicSharedViewGroupDataListResponse as PublicSharedViewGroupDataListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PublicSharedViewGroupDataListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PublicSharedViewGroupDataListResponse
...
class BaseApi(api_client.Api):
    ...
    def _shared_view_group_data_list_mapped_args(
        self,
    ...
    async def _ashared_view_group_data_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public/shared-view/{sharedViewUuid}/group/{columnId}',
            headers=_headers,
        )
    ...
    def _shared_view_group_data_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SharedViewGroupDataListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashared_view_group_data_list(
        self,
        shared_view_uuid: str,
        column_id: Id,
        xc_password: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._shared_view_group_data_list_mapped_args(
        ...
        return await self._ashared_view_group_data_list_oapg(
    ...
    def shared_view_group_data_list(
        self,
        shared_view_uuid: str,
        column_id: Id,
        xc_password: typing.Optional[str] = None,
        ...
        return self._shared_view_group_data_list_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class SharedViewGroupDataList(BaseApi):
    ...
    async def ashared_view_group_data_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicSharedViewGroupDataListResponsePydantic:
        raw_response = await self.raw.ashared_view_group_data_list(
            shared_view_uuid=shared_view_uuid,
            column_id=column_id,
            xc_password=xc_password,
            fields=fields,
        ...
        if validate:
            return RootModel[PublicSharedViewGroupDataListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PublicSharedViewGroupDataListResponsePydantic, raw_response.body)
    ...
    def shared_view_group_data_list(
        ...
        raw_response = self.raw.shared_view_group_data_list(
            shared_view_uuid=shared_view_uuid,
            column_id=column_id,
            xc_password=xc_password,
            fields=fields,
