...
from noco_db_python_sdk.model.base_get_info_by_id_response import BaseGetInfoByIdResponse as BaseGetInfoByIdResponseSchema
...
from noco_db_python_sdk.type.base_get_info_by_id_response import BaseGetInfoByIdResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.base_get_info_by_id_response import BaseGetInfoByIdResponse as BaseGetInfoByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseGetInfoByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseGetInfoByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_info_by_id_mapped_args(
        self,
        base_id: Id,
    ...
    async def _aget_info_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/info',
            headers=_headers,
        )
...
class GetInfoByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_info_by_id(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_info_by_id_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._aget_info_by_id_oapg(
    ...
    def get_info_by_id(
        ...
        return self._get_info_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetInfoById(BaseApi):
    ...
    async def aget_info_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseGetInfoByIdResponsePydantic:
        raw_response = await self.raw.aget_info_by_id(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return BaseGetInfoByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BaseGetInfoByIdResponsePydantic, raw_response.body)
    ...
    def get_info_by_id(
        ...
        raw_response = self.raw.get_info_by_id(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
