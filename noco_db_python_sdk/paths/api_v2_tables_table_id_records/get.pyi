...
from noco_db_python_sdk.model.table_records_list_response import TableRecordsListResponse as TableRecordsListResponseSchema

from noco_db_python_sdk.type.table_records_list_response import TableRecordsListResponse
...
from noco_db_python_sdk.pydantic.table_records_list_response import TableRecordsListResponse as TableRecordsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TableRecordsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TableRecordsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TableRecordsListResponsePydantic:
        ...
        if validate:
            return TableRecordsListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TableRecordsListResponsePydantic, raw_response.body)
