...
SchemaFor200ResponseBodyApplicationJson = SharedViewReqSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_shared_view_mapped_args(
        self,
        view_id: str,
    ...
    async def _acreate_shared_view_oapg(
        self,
...
class CreateSharedViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_shared_view(
        self,
        view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._create_shared_view_mapped_args(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        return await self._acreate_shared_view_oapg(
    ...
    def create_shared_view(
        ...
        return self._create_shared_view_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreateSharedView(BaseApi):
    ...
    async def acreate_shared_view(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SharedViewReqPydantic:
        raw_response = await self.raw.acreate_shared_view(
            view_id=view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return SharedViewReqPydantic(**raw_response.body)
        return api_client.construct_model_instance(SharedViewReqPydantic, raw_response.body)
    ...
    def create_shared_view(
        ...
        raw_response = self.raw.create_shared_view(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        if validate:
