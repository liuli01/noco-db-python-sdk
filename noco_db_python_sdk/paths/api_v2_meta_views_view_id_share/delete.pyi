...
class BaseApi(api_client.Api):
    ...
    def _delete_shared_view_mapped_args(
        self,
        view_id: str,
    ...
    async def _adelete_shared_view_oapg(
        self,
...
class DeleteSharedViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_shared_view(
        self,
        view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_shared_view_mapped_args(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        return await self._adelete_shared_view_oapg(
    ...
    def delete_shared_view(
        ...
        return self._delete_shared_view_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteSharedView(BaseApi):
    ...
    async def adelete_shared_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_shared_view(
            view_id=view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def delete_shared_view(
        ...
        raw_response = self.raw.delete_shared_view(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        if validate:
