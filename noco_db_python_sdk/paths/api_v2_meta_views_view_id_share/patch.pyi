...
from noco_db_python_sdk.model.shared_view_req import SharedViewReq as SharedViewReqSchema
...
from noco_db_python_sdk.type.shared_view_req import SharedViewReq
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.shared_view_req import SharedViewReq as SharedViewReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SharedViewReqSchema


request_body_shared_view_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_shared_view_mapped_args(
        self,
        view_id: str,
        meta: typing.Optional[Meta] = None,
        password: typing.Optional[StringOrNull] = None,
    ...
    async def _aupdate_shared_view_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}/share',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_shared_view_req.serialize(body, content_type)
...
class UpdateSharedViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_shared_view(
        self,
        view_id: str,
        meta: typing.Optional[Meta] = None,
        password: typing.Optional[StringOrNull] = None,
        ...
        **kwargs,
        ...
        args = self._update_shared_view_mapped_args(
            view_id=view_id,
            meta=meta,
            password=password,
            xc_auth=xc_auth,
        )
        return await self._aupdate_shared_view_oapg(
            body=args.body,
    ...
    def update_shared_view(
        ...
        return self._update_shared_view_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateSharedView(BaseApi):
    ...
    async def aupdate_shared_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_shared_view(
            view_id=view_id,
            meta=meta,
            password=password,
            xc_auth=xc_auth,
    ...
    def update_shared_view(
        ...
        raw_response = self.raw.update_shared_view(
            view_id=view_id,
            meta=meta,
            password=password,
            xc_auth=xc_auth,
