...
from noco_db_python_sdk.model.project_list import ProjectList as ProjectListSchema
...
from noco_db_python_sdk.type.project_list import ProjectList
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.project_list import ProjectList as ProjectListPydantic
...
class ListBasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_bases(
        self,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_bases_mapped_args(
            xc_auth=xc_auth,
        )
        return await self._alist_bases_oapg(
    ...
    def list_bases(
        ...
        return self._list_bases_oapg(
            header_params=args.header,
        )

class ListBases(BaseApi):
    ...
    async def alist_bases(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_bases(
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
    ...
    def list_bases(
        ...
        raw_response = self.raw.list_bases(
            xc_auth=xc_auth,
        )
        if validate:
            return ProjectListPydantic(**raw_response.body)
