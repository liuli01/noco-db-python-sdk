...
from noco_db_python_sdk.model.map_update_req import MapUpdateReq as MapUpdateReqSchema
...
from noco_db_python_sdk.type.map_update_req import MapUpdateReq
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.map_update_req import MapUpdateReq as MapUpdateReqPydantic
...
# Path params
MapViewIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'mapViewId': typing.Union[MapViewIdSchema, str, ],
    }
)
...
request_path_map_view_id = api_client.PathParameter(
    name="mapViewId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MapViewIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = MapUpdateReqSchema


request_body_map_update_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_map_view_data_mapped_args(
        self,
        map_view_id: str,
        fk_geo_data_col_id: typing.Optional[str] = None,
        ...
        if map_view_id is not None:
            _path_params["mapViewId"] = map_view_id
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aupdate_map_view_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/maps/{mapViewId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_map_update_req.serialize(body, content_type)
    ...
    def _update_map_view_data_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateMapViewDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_map_view_data(
        self,
        map_view_id: str,
        fk_geo_data_col_id: typing.Optional[str] = None,
        meta: typing.Optional[Meta] = None,
        ...
        **kwargs,
        ...
        args = self._update_map_view_data_mapped_args(
            map_view_id=map_view_id,
            fk_geo_data_col_id=fk_geo_data_col_id,
            meta=meta,
            xc_auth=xc_auth,
        )
        return await self._aupdate_map_view_data_oapg(
            body=args.body,
    ...
    def update_map_view_data(
        ...
        return self._update_map_view_data_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateMapViewData(BaseApi):
    ...
    async def aupdate_map_view_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_map_view_data(
            map_view_id=map_view_id,
            fk_geo_data_col_id=fk_geo_data_col_id,
            meta=meta,
            xc_auth=xc_auth,
    ...
    def update_map_view_data(
        ...
        raw_response = self.raw.update_map_view_data(
            map_view_id=map_view_id,
            fk_geo_data_col_id=fk_geo_data_col_id,
            meta=meta,
            xc_auth=xc_auth,
