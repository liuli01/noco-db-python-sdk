...
class BaseApi(api_client.Api):
    ...
    def _create_map_view_mapped_args(
        self,
        title: str,
        table_id: Id,
    ...
    async def _acreate_map_view_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/tables/{tableId}/maps',
            body=body,
            headers=_headers,
        )
...
class CreateMapViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_map_view(
        self,
        title: str,
        table_id: Id,
        type: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._create_map_view_mapped_args(
            title=title,
            table_id=table_id,
            type=type,
        ...
        return await self._acreate_map_view_oapg(
            body=args.body,
    ...
    def create_map_view(
        ...
        return self._create_map_view_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateMapView(BaseApi):
    ...
    async def acreate_map_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_map_view(
            title=title,
            table_id=table_id,
            type=type,
            copy_from_id=copy_from_id,
    ...
    def create_map_view(
        ...
        raw_response = self.raw.create_map_view(
            title=title,
            table_id=table_id,
            type=type,
            copy_from_id=copy_from_id,
