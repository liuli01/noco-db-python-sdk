...
from noco_db_python_sdk.model.source_update_details_request import SourceUpdateDetailsRequest as SourceUpdateDetailsRequestSchema
from noco_db_python_sdk.model.source_update_details_request_config import SourceUpdateDetailsRequestConfig as SourceUpdateDetailsRequestConfigSchema
...
from noco_db_python_sdk.type.source_update_details_request import SourceUpdateDetailsRequest
...
from noco_db_python_sdk.pydantic.source_update_details_request_config import SourceUpdateDetailsRequestConfig as SourceUpdateDetailsRequestConfigPydantic
...
from noco_db_python_sdk.pydantic.source_update_details_request import SourceUpdateDetailsRequest as SourceUpdateDetailsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SourceUpdateDetailsRequestSchema


request_body_source_update_details_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_details_mapped_args(
        ...
        config: typing.Optional[SourceUpdateDetailsRequestConfig] = None,
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/sources/{sourceId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_source_update_details_request.serialize(body, content_type)
