...
from noco_db_python_sdk.model.table_req import TableReq as TableReqSchema
from noco_db_python_sdk.model.table import Table as TableSchema
...
from noco_db_python_sdk.model.normal_column_request import NormalColumnRequest as NormalColumnRequestSchema
...
from noco_db_python_sdk.type.table_req import TableReq
...
from noco_db_python_sdk.pydantic.normal_column_request import NormalColumnRequest as NormalColumnRequestPydantic
...
from noco_db_python_sdk.pydantic.table import Table as TablePydantic
from noco_db_python_sdk.pydantic.table_req import TableReq as TableReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TableReqSchema


request_body_table_req = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = TableSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_table_mapped_args(
        self,
    ...
    async def _acreate_new_table_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/tables',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_table_req.serialize(body, content_type)
...
class CreateNewTableRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_table(
        self,
        columns: typing.List[NormalColumnRequest],
        table_name: str,
        base_id: Id,
        ...
        **kwargs,
        ...
        args = self._create_new_table_mapped_args(
            columns=columns,
        ...
        return await self._acreate_new_table_oapg(
            body=args.body,
    ...
    def create_new_table(
        ...
        return self._create_new_table_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateNewTable(BaseApi):
    ...
    async def acreate_new_table(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_table(
            columns=columns,
            table_name=table_name,
            base_id=base_id,
            title=title,
        ...
        if validate:
            return TablePydantic(**raw_response.body)
        return api_client.construct_model_instance(TablePydantic, raw_response.body)
    ...
    def create_new_table(
        ...
        raw_response = self.raw.create_new_table(
            columns=columns,
            table_name=table_name,
            base_id=base_id,
            title=title,
