...
class ListTablesRaw(BaseApi):
    ...
    async def alist_tables(
        ...
        **kwargs,
        ...
        args = self._list_tables_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
            page=page,
            page_size=page_size,
        ...
        return await self._alist_tables_oapg(
...
class ListTables(BaseApi):
    ...
    async def alist_tables(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_tables(
            base_id=base_id,
            xc_auth=xc_auth,
            page=page,
            page_size=page_size,
    ...
    def list_tables(
        ...
        raw_response = self.raw.list_tables(
            base_id=base_id,
            xc_auth=xc_auth,
            page=page,
            page_size=page_size,
