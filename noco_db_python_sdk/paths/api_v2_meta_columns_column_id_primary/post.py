...
class BaseApi(api_client.Api):
    ...
    def _set_primary_value_mapped_args(
        self,
        column_id: str,
    ...
    async def _aset_primary_value_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/columns/{columnId}/primary',
            headers=_headers,
        )
...
class SetPrimaryValueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_primary_value(
        self,
        column_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._set_primary_value_mapped_args(
            column_id=column_id,
            xc_auth=xc_auth,
        )
        return await self._aset_primary_value_oapg(
    ...
    def set_primary_value(
        ...
        return self._set_primary_value_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SetPrimaryValue(BaseApi):
    ...
    async def aset_primary_value(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_primary_value(
            column_id=column_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def set_primary_value(
        ...
        raw_response = self.raw.set_primary_value(
            column_id=column_id,
            xc_auth=xc_auth,
        )
        if validate:
