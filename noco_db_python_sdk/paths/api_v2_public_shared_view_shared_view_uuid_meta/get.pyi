...
from noco_db_python_sdk.model.public_view_meta_get_response import PublicViewMetaGetResponse as PublicViewMetaGetResponseSchema

from noco_db_python_sdk.type.public_view_meta_get_response import PublicViewMetaGetResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.public_view_meta_get_response import PublicViewMetaGetResponse as PublicViewMetaGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PublicViewMetaGetResponseSchema
SchemaFor200ResponseBodyApplicationXml = schemas.AnyTypeSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PublicViewMetaGetResponse
...
class BaseApi(api_client.Api):
    ...
    def _view_meta_get_mapped_args(
        self,
    ...
    async def _aview_meta_get_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public/shared-view/{sharedViewUuid}/meta',
            headers=_headers,
        )
...
class ViewMetaGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aview_meta_get(
        self,
        shared_view_uuid: str,
        xc_password: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._view_meta_get_mapped_args(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
        )
        return await self._aview_meta_get_oapg(
    ...
    def view_meta_get(
        ...
        return self._view_meta_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ViewMetaGet(BaseApi):
    ...
    async def aview_meta_get(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicViewMetaGetResponsePydantic:
        raw_response = await self.raw.aview_meta_get(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            **kwargs,
        )
        if validate:
            return RootModel[PublicViewMetaGetResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PublicViewMetaGetResponsePydantic, raw_response.body)
    ...
    def view_meta_get(
        ...
        raw_response = self.raw.view_meta_get(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
        )
        if validate:
