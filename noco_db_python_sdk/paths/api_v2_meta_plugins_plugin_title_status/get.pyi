...
# Path params
PluginTitleSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'pluginTitle': typing.Union[PluginTitleSchema, str, ],
    }
)
...
request_path_plugin_title = api_client.PathParameter(
    name="pluginTitle",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PluginTitleSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_status_mapped_args(
        ...
        if plugin_title is not None:
            _path_params["pluginTitle"] = plugin_title
    ...
    async def _aget_status_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/plugins/{pluginTitle}/status',
            headers=_headers,
        )
