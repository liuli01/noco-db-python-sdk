...
from noco_db_python_sdk.model.auth_list_base_users_response import AuthListBaseUsersResponse as AuthListBaseUsersResponseSchema
...
from noco_db_python_sdk.type.auth_list_base_users_response import AuthListBaseUsersResponse
...
from noco_db_python_sdk.pydantic.auth_list_base_users_response import AuthListBaseUsersResponse as AuthListBaseUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AuthListBaseUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AuthListBaseUsersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_base_users_mapped_args(
        self,
        base_id: Id,
    ...
    async def _alist_base_users_oapg(
        self,
...
class ListBaseUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_base_users(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_base_users_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._alist_base_users_oapg(
    ...
    def list_base_users(
        ...
        return self._list_base_users_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListBaseUsers(BaseApi):
    ...
    async def alist_base_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AuthListBaseUsersResponsePydantic:
        raw_response = await self.raw.alist_base_users(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return AuthListBaseUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AuthListBaseUsersResponsePydantic, raw_response.body)
    ...
    def list_base_users(
        ...
        raw_response = self.raw.list_base_users(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
