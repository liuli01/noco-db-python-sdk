...
from noco_db_python_sdk.model.view_update_req import ViewUpdateReq as ViewUpdateReqSchema
...
from noco_db_python_sdk.type.view_update_req import ViewUpdateReq
...
from noco_db_python_sdk.pydantic.view_update_req import ViewUpdateReq as ViewUpdateReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ViewUpdateReqSchema


request_body_view_update_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_by_id_mapped_args(
        ...
        lock_type: typing.Optional[str] = None,
        meta: typing.Optional[Meta] = None,
        order: typing.Optional[typing.Union[int, float]] = None,
        show_system_fields: typing.Optional[ModelBool] = None,
        ...
        if lock_type is not None:
            _body["lock_type"] = lock_type
        if meta is not None:
            _body["meta"] = meta
        if order is not None:
            _body["order"] = order
        if show_system_fields is not None:
            _body["show_system_fields"] = show_system_fields
        args.body = _body
    ...
    async def _aupdate_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_view_update_req.serialize(body, content_type)
