...
class BaseApi(api_client.Api):
    ...
    def _delete_erd_share_mapped_args(
        self,
        base_id: str,
        source_id: str,
    ...
    async def _adelete_erd_share_oapg(
        self,
...
class DeleteErdShareRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_erd_share(
        self,
        base_id: str,
        source_id: str,
        **kwargs,
        ...
        args = self._delete_erd_share_mapped_args(
            base_id=base_id,
            source_id=source_id,
        )
        return await self._adelete_erd_share_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_erd_share(
        self,
        base_id: str,
        source_id: str,
    ) -> typing.Union[
        ...
        return self._delete_erd_share_oapg(
            path_params=args.path,
        )

class DeleteErdShare(BaseApi):
    ...
    async def adelete_erd_share(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_erd_share(
            base_id=base_id,
            source_id=source_id,
            **kwargs,
        )
    ...
    def delete_erd_share(
        ...
        raw_response = self.raw.delete_erd_share(
            base_id=base_id,
            source_id=source_id,
        )
