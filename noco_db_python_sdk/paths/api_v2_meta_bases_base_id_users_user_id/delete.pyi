...
from noco_db_python_sdk.model.auth_delete_base_user_response import AuthDeleteBaseUserResponse as AuthDeleteBaseUserResponseSchema
from noco_db_python_sdk.model.id import Id as IdSchema

from noco_db_python_sdk.type.id import Id
from noco_db_python_sdk.type.auth_delete_base_user_response import AuthDeleteBaseUserResponse
...
from noco_db_python_sdk.pydantic.auth_delete_base_user_response import AuthDeleteBaseUserResponse as AuthDeleteBaseUserResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AuthDeleteBaseUserResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AuthDeleteBaseUserResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_base_user_mapped_args(
        self,
        base_id: Id,
        user_id: Id,
    ...
    async def _adelete_base_user_oapg(
        self,
...
class DeleteBaseUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_base_user(
        self,
        base_id: Id,
        user_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_base_user_mapped_args(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
        )
        return await self._adelete_base_user_oapg(
    ...
    def delete_base_user(
        ...
        return self._delete_base_user_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteBaseUser(BaseApi):
    ...
    async def adelete_base_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AuthDeleteBaseUserResponsePydantic:
        raw_response = await self.raw.adelete_base_user(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
            **kwargs,
        ...
        if validate:
            return AuthDeleteBaseUserResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AuthDeleteBaseUserResponsePydantic, raw_response.body)
    ...
    def delete_base_user(
        ...
        raw_response = self.raw.delete_base_user(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
        )
