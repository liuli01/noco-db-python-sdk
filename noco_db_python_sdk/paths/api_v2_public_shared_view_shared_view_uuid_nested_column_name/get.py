...
class BaseApi(api_client.Api):
    ...
    def _nested_data_relation_list_mapped_args(
        self,
    ...
    async def _anested_data_relation_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public/shared-view/{sharedViewUuid}/nested/{columnName}',
            headers=_headers,
        )
    ...
    def _nested_data_relation_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class NestedDataRelationListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def anested_data_relation_list(
        self,
        shared_view_uuid: str,
        column_name: str,
        xc_password: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._nested_data_relation_list_mapped_args(
        ...
        return await self._anested_data_relation_list_oapg(
    ...
    def nested_data_relation_list(
        ...
        return self._nested_data_relation_list_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class NestedDataRelationList(BaseApi):
    ...
    async def anested_data_relation_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.anested_data_relation_list(
            shared_view_uuid=shared_view_uuid,
            column_name=column_name,
            xc_password=xc_password,
            fields=fields,
    ...
    def nested_data_relation_list(
        ...
        raw_response = self.raw.nested_data_relation_list(
            shared_view_uuid=shared_view_uuid,
            column_name=column_name,
            xc_password=xc_password,
            fields=fields,
