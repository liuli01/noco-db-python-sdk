...
from noco_db_python_sdk.model.hook_log_list import HookLogList as HookLogListSchema
...
from noco_db_python_sdk.type.hook_log_list import HookLogList
...
from noco_db_python_sdk.pydantic.hook_log_list import HookLogList as HookLogListPydantic
...
SchemaFor200ResponseBodyApplicationJson = HookLogListSchema
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/hooks/{hookId}/logs',
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return HookLogListPydantic(**raw_response.body)
        return api_client.construct_model_instance(HookLogListPydantic, raw_response.body)
