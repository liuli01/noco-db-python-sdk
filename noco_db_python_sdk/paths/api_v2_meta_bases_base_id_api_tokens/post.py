...
from noco_db_python_sdk.model.api_token import ApiToken as ApiTokenSchema
from noco_db_python_sdk.model.api_token_req import ApiTokenReq as ApiTokenReqSchema
...
from noco_db_python_sdk.type.api_token_req import ApiTokenReq
...
from noco_db_python_sdk.pydantic.api_token_req import ApiTokenReq as ApiTokenReqPydantic
from noco_db_python_sdk.pydantic.api_token import ApiToken as ApiTokenPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ApiTokenReqSchema


request_body_api_token_req = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = ApiTokenSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_in_base_mapped_args(
        self,
        base_id: Id,
    ...
    async def _acreate_in_base_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/api-tokens',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_api_token_req.serialize(body, content_type)
...
class CreateInBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_in_base(
        self,
        base_id: Id,
        description: typing.Optional[str] = None,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._create_in_base_mapped_args(
            base_id=base_id,
            description=description,
            xc_auth=xc_auth,
        )
        return await self._acreate_in_base_oapg(
            body=args.body,
    ...
    def create_in_base(
        ...
        return self._create_in_base_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateInBase(BaseApi):
    ...
    async def acreate_in_base(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_in_base(
            base_id=base_id,
            description=description,
            xc_auth=xc_auth,
            **kwargs,
        ...
        if validate:
            return ApiTokenPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiTokenPydantic, raw_response.body)
    ...
    def create_in_base(
        ...
        raw_response = self.raw.create_in_base(
            base_id=base_id,
            description=description,
            xc_auth=xc_auth,
        )
