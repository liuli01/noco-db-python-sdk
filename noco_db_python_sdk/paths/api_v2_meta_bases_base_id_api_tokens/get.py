...
from noco_db_python_sdk.model.api_token_list import ApiTokenList as ApiTokenListSchema
...
from noco_db_python_sdk.type.api_token_list import ApiTokenList
...
from noco_db_python_sdk.pydantic.api_token_list import ApiTokenList as ApiTokenListPydantic
...
SchemaFor200ResponseBodyApplicationJson = ApiTokenListSchema
...
class ListInBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_in_base(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_in_base_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._alist_in_base_oapg(
    ...
    def list_in_base(
        ...
        return self._list_in_base_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListInBase(BaseApi):
    ...
    async def alist_in_base(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApiTokenListPydantic:
        raw_response = await self.raw.alist_in_base(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return ApiTokenListPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApiTokenListPydantic, raw_response.body)
    ...
    def list_in_base(
        ...
        raw_response = self.raw.list_in_base(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
