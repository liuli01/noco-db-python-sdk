...
from noco_db_python_sdk.model.sort_req import SortReq as SortReqSchema
...
from noco_db_python_sdk.pydantic.sort_req import SortReq as SortReqPydantic
...
# Path params
SortIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'sortId': typing.Union[SortIdSchema, str, ],
    }
)
...
request_path_sort_id = api_client.PathParameter(
    name="sortId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SortIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = SortReqSchema


request_body_sort_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_sort_by_id_mapped_args(
        self,
        sort_id: str,
        ...
        if sort_id is not None:
            _path_params["sortId"] = sort_id
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aupdate_sort_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/sorts/{sortId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_sort_req.serialize(body, content_type)
...
class UpdateSortByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_sort_by_id(
        self,
        sort_id: str,
        fk_column_id: typing.Optional[Id] = None,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_sort_by_id_mapped_args(
            sort_id=sort_id,
            fk_column_id=fk_column_id,
            direction=direction,
            xc_auth=xc_auth,
        )
        return await self._aupdate_sort_by_id_oapg(
            body=args.body,
    ...
    def update_sort_by_id(
        ...
        return self._update_sort_by_id_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateSortById(BaseApi):
    ...
    async def aupdate_sort_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_sort_by_id(
            sort_id=sort_id,
            fk_column_id=fk_column_id,
            direction=direction,
            xc_auth=xc_auth,
    ...
    def update_sort_by_id(
        ...
        raw_response = self.raw.update_sort_by_id(
            sort_id=sort_id,
            fk_column_id=fk_column_id,
            direction=direction,
            xc_auth=xc_auth,
