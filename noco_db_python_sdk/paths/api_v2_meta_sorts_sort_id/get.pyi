...
from noco_db_python_sdk.model.sort import Sort as SortSchema
...
from noco_db_python_sdk.pydantic.sort import Sort as SortPydantic
...
SchemaFor200ResponseBodyApplicationJson = SortSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_sort_by_id_mapped_args(
        self,
        sort_id: str,
    ...
    async def _aget_sort_by_id_oapg(
        self,
...
class GetSortByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sort_by_id(
        self,
        sort_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_sort_by_id_mapped_args(
            sort_id=sort_id,
            xc_auth=xc_auth,
        )
        return await self._aget_sort_by_id_oapg(
    ...
    def get_sort_by_id(
        ...
        return self._get_sort_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetSortById(BaseApi):
    ...
    async def aget_sort_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_sort_by_id(
            sort_id=sort_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return SortPydantic(**raw_response.body)
        return api_client.construct_model_instance(SortPydantic, raw_response.body)
    ...
    def get_sort_by_id(
        ...
        raw_response = self.raw.get_sort_by_id(
            sort_id=sort_id,
            xc_auth=xc_auth,
        )
        if validate:
