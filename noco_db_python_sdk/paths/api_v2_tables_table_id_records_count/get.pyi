...
from noco_db_python_sdk.model.table_records_get_count_response import TableRecordsGetCountResponse as TableRecordsGetCountResponseSchema
...
from noco_db_python_sdk.type.table_records_get_count_response import TableRecordsGetCountResponse
...
from noco_db_python_sdk.pydantic.table_records_get_count_response import TableRecordsGetCountResponse as TableRecordsGetCountResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TableRecordsGetCountResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TableRecordsGetCountResponse
    ...
    async def _aget_count_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/tables/{tableId}/records/count',
            headers=_headers,
        )
...
class GetCountRaw(BaseApi):
    ...
    async def aget_count(
        ...
        **kwargs,
        ...
        args = self._get_count_mapped_args(
            table_id=table_id,
            view_id=view_id,
            where=where,
            xc_auth=xc_auth,
        )
        return await self._aget_count_oapg(
    ...
    def get_count(
        ...
        return self._get_count_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetCount(BaseApi):
    ...
    async def aget_count(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TableRecordsGetCountResponsePydantic:
        raw_response = await self.raw.aget_count(
            table_id=table_id,
            view_id=view_id,
            where=where,
            xc_auth=xc_auth,
        ...
        if validate:
            return TableRecordsGetCountResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TableRecordsGetCountResponsePydantic, raw_response.body)
    ...
    def get_count(
        ...
        raw_response = self.raw.get_count(
            table_id=table_id,
            view_id=view_id,
            where=where,
            xc_auth=xc_auth,
