...
class BaseApi(api_client.Api):
    ...
    def _calculate_cost_mapped_args(
        self,
        base_id: Id,
    ...
    async def _acalculate_cost_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/cost',
            headers=_headers,
        )
...
class CalculateCostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acalculate_cost(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._calculate_cost_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._acalculate_cost_oapg(
    ...
    def calculate_cost(
        ...
        return self._calculate_cost_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CalculateCost(BaseApi):
    ...
    async def acalculate_cost(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acalculate_cost(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def calculate_cost(
        ...
        raw_response = self.raw.calculate_cost(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
