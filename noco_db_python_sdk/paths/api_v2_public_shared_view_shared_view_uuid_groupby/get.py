...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'column_name': typing.Union[ColumnNameSchema, str, ],
    },
    total=False
)
...
request_query_column_name = api_client.QueryParameter(
    name="column_name",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _list_shared_view_rows_group_by_mapped_args(
        self,
        ...
        if column_name is not None:
            _query_params["column_name"] = column_name
    ...
    async def _alist_shared_view_rows_group_by_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public/shared-view/{sharedViewUuid}/groupby',
            headers=_headers,
        )
    ...
    def _list_shared_view_rows_group_by_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ListSharedViewRowsGroupByRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_shared_view_rows_group_by(
        self,
        shared_view_uuid: str,
        xc_password: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_shared_view_rows_group_by_mapped_args(
        ...
        return await self._alist_shared_view_rows_group_by_oapg(
    ...
    def list_shared_view_rows_group_by(
        self,
        shared_view_uuid: str,
        xc_password: typing.Optional[str] = None,
        fields: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._list_shared_view_rows_group_by_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ListSharedViewRowsGroupBy(BaseApi):
    ...
    async def alist_shared_view_rows_group_by(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_shared_view_rows_group_by(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            fields=fields,
            sort=sort,
    ...
    def list_shared_view_rows_group_by(
        ...
        raw_response = self.raw.list_shared_view_rows_group_by(
            shared_view_uuid=shared_view_uuid,
            xc_password=xc_password,
            fields=fields,
            sort=sort,
