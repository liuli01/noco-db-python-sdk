...
from noco_db_python_sdk.model.hook_list import HookList as HookListSchema
...
from noco_db_python_sdk.type.hook_list import HookList
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.hook_list import HookList as HookListPydantic
...
SchemaFor200ResponseBodyApplicationJson = HookListSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_table_hooks_mapped_args(
        self,
        table_id: Id,
    ...
    async def _alist_table_hooks_oapg(
        self,
...
class ListTableHooksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_table_hooks(
        self,
        table_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_table_hooks_mapped_args(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        return await self._alist_table_hooks_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def list_table_hooks(
        self,
        table_id: Id,
        xc_auth: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._list_table_hooks_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListTableHooks(BaseApi):
    ...
    async def alist_table_hooks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_table_hooks(
            table_id=table_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return HookListPydantic(**raw_response.body)
        return api_client.construct_model_instance(HookListPydantic, raw_response.body)
    ...
    def list_table_hooks(
        ...
        raw_response = self.raw.list_table_hooks(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        if validate:
