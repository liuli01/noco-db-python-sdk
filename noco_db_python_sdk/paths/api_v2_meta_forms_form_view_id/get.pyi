...
from noco_db_python_sdk.model.form import Form as FormSchema
...
from noco_db_python_sdk.pydantic.form import Form as FormPydantic
...
SchemaFor200ResponseBodyApplicationJson = FormSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_form_by_id_mapped_args(
        self,
        form_view_id: Id,
    ...
    async def _aget_form_by_id_oapg(
        self,
...
class GetFormByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_form_by_id(
        self,
        form_view_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_form_by_id_mapped_args(
            form_view_id=form_view_id,
            xc_auth=xc_auth,
        )
        return await self._aget_form_by_id_oapg(
    ...
    def get_form_by_id(
        ...
        return self._get_form_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetFormById(BaseApi):
    ...
    async def aget_form_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_form_by_id(
            form_view_id=form_view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return FormPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormPydantic, raw_response.body)
    ...
    def get_form_by_id(
        ...
        raw_response = self.raw.get_form_by_id(
            form_view_id=form_view_id,
            xc_auth=xc_auth,
        )
        if validate:
