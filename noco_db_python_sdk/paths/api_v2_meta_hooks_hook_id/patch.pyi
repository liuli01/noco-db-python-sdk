...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'hookId': typing.Union[HookIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = HookSchema


request_body_hook = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_by_id_mapped_args(
        ...
        notification: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
    ...
    async def _aupdate_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/hooks/{hookId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_hook.serialize(body, content_type)
