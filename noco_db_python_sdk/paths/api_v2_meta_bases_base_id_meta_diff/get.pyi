...
from noco_db_python_sdk.model.base_meta_diff_get_response import BaseMetaDiffGetResponse as BaseMetaDiffGetResponseSchema
...
from noco_db_python_sdk.type.base_meta_diff_get_response import BaseMetaDiffGetResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.base_meta_diff_get_response import BaseMetaDiffGetResponse as BaseMetaDiffGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseMetaDiffGetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseMetaDiffGetResponse
...
class BaseApi(api_client.Api):
    ...
    def _meta_diff_get_mapped_args(
        self,
        base_id: Id,
    ...
    async def _ameta_diff_get_oapg(
        self,
...
class MetaDiffGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ameta_diff_get(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._meta_diff_get_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._ameta_diff_get_oapg(
    ...
    def meta_diff_get(
        ...
        return self._meta_diff_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class MetaDiffGet(BaseApi):
    ...
    async def ameta_diff_get(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseMetaDiffGetResponsePydantic:
        raw_response = await self.raw.ameta_diff_get(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return RootModel[BaseMetaDiffGetResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BaseMetaDiffGetResponsePydantic, raw_response.body)
    ...
    def meta_diff_get(
        ...
        raw_response = self.raw.meta_diff_get(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
