...
from noco_db_python_sdk.model.base_sync_meta_diff_response import BaseSyncMetaDiffResponse as BaseSyncMetaDiffResponseSchema
...
from noco_db_python_sdk.type.base_sync_meta_diff_response import BaseSyncMetaDiffResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.base_sync_meta_diff_response import BaseSyncMetaDiffResponse as BaseSyncMetaDiffResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseSyncMetaDiffResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseSyncMetaDiffResponse
...
class BaseApi(api_client.Api):
    ...
    def _sync_meta_diff_mapped_args(
        self,
        base_id: Id,
    ...
    async def _async_meta_diff_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/meta-diff',
            headers=_headers,
        )
...
class SyncMetaDiffRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def async_meta_diff(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._sync_meta_diff_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._async_meta_diff_oapg(
    ...
    def sync_meta_diff(
        ...
        return self._sync_meta_diff_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SyncMetaDiff(BaseApi):
    ...
    async def async_meta_diff(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseSyncMetaDiffResponsePydantic:
        raw_response = await self.raw.async_meta_diff(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return BaseSyncMetaDiffResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BaseSyncMetaDiffResponsePydantic, raw_response.body)
    ...
    def sync_meta_diff(
        ...
        raw_response = self.raw.sync_meta_diff(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
