...
class RemoveBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_base(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_base_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._aremove_base_oapg(
    ...
    def remove_base(
        ...
        return self._remove_base_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RemoveBase(BaseApi):
    ...
    async def aremove_base(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_base(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def remove_base(
        ...
        raw_response = self.raw.remove_base(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
