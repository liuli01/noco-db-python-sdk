...
from noco_db_python_sdk.model.base_list_audits_in_base_response import BaseListAuditsInBaseResponse as BaseListAuditsInBaseResponseSchema
...
from noco_db_python_sdk.type.base_list_audits_in_base_response import BaseListAuditsInBaseResponse
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.base_list_audits_in_base_response import BaseListAuditsInBaseResponse as BaseListAuditsInBaseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseListAuditsInBaseResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseListAuditsInBaseResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_audits_in_base_mapped_args(
        self,
        base_id: Id,
    ...
    async def _alist_audits_in_base_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/audits',
            headers=_headers,
        )
...
class ListAuditsInBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_audits_in_base(
        self,
        base_id: Id,
        offset: typing.Optional[int] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_audits_in_base_mapped_args(
            base_id=base_id,
            offset=offset,
            limit=limit,
            source_id=source_id,
        ...
        return await self._alist_audits_in_base_oapg(
    ...
    def list_audits_in_base(
        ...
        return self._list_audits_in_base_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ListAuditsInBase(BaseApi):
    ...
    async def alist_audits_in_base(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseListAuditsInBaseResponsePydantic:
        raw_response = await self.raw.alist_audits_in_base(
            base_id=base_id,
            offset=offset,
            limit=limit,
            source_id=source_id,
        ...
        if validate:
            return BaseListAuditsInBaseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BaseListAuditsInBaseResponsePydantic, raw_response.body)
    ...
    def list_audits_in_base(
        ...
        raw_response = self.raw.list_audits_in_base(
            base_id=base_id,
            offset=offset,
            limit=limit,
            source_id=source_id,
