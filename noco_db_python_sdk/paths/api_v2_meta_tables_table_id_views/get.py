...
from noco_db_python_sdk.model.view_list import ViewList as ViewListSchema
...
from noco_db_python_sdk.type.view_list import ViewList
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.view_list import ViewList as ViewListPydantic
...
SchemaFor200ResponseBodyApplicationJson = ViewListSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_table_views_mapped_args(
        self,
        table_id: Id,
    ...
    async def _alist_table_views_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/tables/{tableId}/views',
            headers=_headers,
        )
...
class ListTableViewsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_table_views(
        self,
        table_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_table_views_mapped_args(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        return await self._alist_table_views_oapg(
    ...
    def list_table_views(
        ...
        return self._list_table_views_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListTableViews(BaseApi):
    ...
    async def alist_table_views(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_table_views(
            table_id=table_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return ViewListPydantic(**raw_response.body)
        return api_client.construct_model_instance(ViewListPydantic, raw_response.body)
    ...
    def list_table_views(
        ...
        raw_response = self.raw.list_table_views(
            table_id=table_id,
            xc_auth=xc_auth,
        )
        if validate:
