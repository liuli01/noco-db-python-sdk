...
class BaseApi(api_client.Api):
    ...
    def _show_all_columns_mapped_args(
        self,
        view_id: Id,
    ...
    async def _ashow_all_columns_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}/show-all',
            headers=_headers,
        )
...
class ShowAllColumnsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_all_columns(
        self,
        view_id: Id,
        ignore_ids: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._show_all_columns_mapped_args(
            view_id=view_id,
            ignore_ids=ignore_ids,
            xc_auth=xc_auth,
        )
        return await self._ashow_all_columns_oapg(
    ...
    def show_all_columns(
        ...
        return self._show_all_columns_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ShowAllColumns(BaseApi):
    ...
    async def ashow_all_columns(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashow_all_columns(
            view_id=view_id,
            ignore_ids=ignore_ids,
            xc_auth=xc_auth,
            **kwargs,
    ...
    def show_all_columns(
        ...
        raw_response = self.raw.show_all_columns(
            view_id=view_id,
            ignore_ids=ignore_ids,
            xc_auth=xc_auth,
        )
