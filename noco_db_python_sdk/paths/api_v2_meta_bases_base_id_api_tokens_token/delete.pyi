...
class BaseApi(api_client.Api):
    ...
    def _delete_in_base_mapped_args(
        self,
        base_id: Id,
        token: str,
    ...
    async def _adelete_in_base_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/api-tokens/{token}',
            headers=_headers,
        )
...
class DeleteInBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_in_base(
        self,
        base_id: Id,
        token: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_in_base_mapped_args(
            base_id=base_id,
            token=token,
            xc_auth=xc_auth,
        )
        return await self._adelete_in_base_oapg(
    ...
    def delete_in_base(
        ...
        return self._delete_in_base_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteInBase(BaseApi):
    ...
    async def adelete_in_base(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_in_base(
            base_id=base_id,
            token=token,
            xc_auth=xc_auth,
            **kwargs,
    ...
    def delete_in_base(
        ...
        raw_response = self.raw.delete_in_base(
            base_id=base_id,
            token=token,
            xc_auth=xc_auth,
        )
