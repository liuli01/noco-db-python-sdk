...
from noco_db_python_sdk.model.kanban import Kanban as KanbanSchema
...
from noco_db_python_sdk.pydantic.kanban import Kanban as KanbanPydantic
...
SchemaFor200ResponseBodyApplicationJson = KanbanSchema
...
class BaseApi(api_client.Api):
    ...
    def _kanban_view_get_mapped_args(
        self,
        kanban_view_id: str,
    ...
    async def _akanban_view_get_oapg(
        self,
...
class KanbanViewGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def akanban_view_get(
        self,
        kanban_view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._kanban_view_get_mapped_args(
            kanban_view_id=kanban_view_id,
            xc_auth=xc_auth,
        )
        return await self._akanban_view_get_oapg(
    ...
    def kanban_view_get(
        ...
        return self._kanban_view_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class KanbanViewGet(BaseApi):
    ...
    async def akanban_view_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.akanban_view_get(
            kanban_view_id=kanban_view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return KanbanPydantic(**raw_response.body)
        return api_client.construct_model_instance(KanbanPydantic, raw_response.body)
    ...
    def kanban_view_get(
        ...
        raw_response = self.raw.kanban_view_get(
            kanban_view_id=kanban_view_id,
            xc_auth=xc_auth,
        )
        if validate:
