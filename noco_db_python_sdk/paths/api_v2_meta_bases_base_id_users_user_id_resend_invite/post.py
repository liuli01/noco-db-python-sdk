...
from noco_db_python_sdk.model.auth_resend_invite_user_response import AuthResendInviteUserResponse as AuthResendInviteUserResponseSchema
...
from noco_db_python_sdk.type.auth_resend_invite_user_response import AuthResendInviteUserResponse
...
from noco_db_python_sdk.pydantic.auth_resend_invite_user_response import AuthResendInviteUserResponse as AuthResendInviteUserResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AuthResendInviteUserResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AuthResendInviteUserResponse
...
class BaseApi(api_client.Api):
    ...
    def _resend_invite_user_mapped_args(
        self,
        base_id: Id,
        user_id: Id,
    ...
    async def _aresend_invite_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/users/{userId}/resend-invite',
            headers=_headers,
        )
...
class ResendInviteUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresend_invite_user(
        self,
        base_id: Id,
        user_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._resend_invite_user_mapped_args(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
        )
        return await self._aresend_invite_user_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def resend_invite_user(
        self,
        base_id: Id,
        user_id: Id,
        xc_auth: typing.Optional[str] = None,
        ...
        return self._resend_invite_user_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ResendInviteUser(BaseApi):
    ...
    async def aresend_invite_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AuthResendInviteUserResponsePydantic:
        raw_response = await self.raw.aresend_invite_user(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
            **kwargs,
        ...
        if validate:
            return AuthResendInviteUserResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AuthResendInviteUserResponsePydantic, raw_response.body)
    ...
    def resend_invite_user(
        ...
        raw_response = self.raw.resend_invite_user(
            base_id=base_id,
            user_id=user_id,
            xc_auth=xc_auth,
        )
