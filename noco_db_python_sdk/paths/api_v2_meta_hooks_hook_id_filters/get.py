...
class BaseApi(api_client.Api):
    ...
    def _get_hook_filter_mapped_args(
        self,
        hook_id: Id,
    ...
    async def _aget_hook_filter_oapg(
        self,
...
class GetHookFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_hook_filter(
        self,
        hook_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_hook_filter_mapped_args(
            hook_id=hook_id,
            xc_auth=xc_auth,
        )
        return await self._aget_hook_filter_oapg(
    ...
    def get_hook_filter(
        ...
        return self._get_hook_filter_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetHookFilter(BaseApi):
    ...
    async def aget_hook_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_hook_filter(
            hook_id=hook_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def get_hook_filter(
        ...
        raw_response = self.raw.get_hook_filter(
            hook_id=hook_id,
            xc_auth=xc_auth,
        )
        if validate:
