...
from noco_db_python_sdk.model.filter import Filter as FilterSchema
...
from noco_db_python_sdk.model.filter_req import FilterReq as FilterReqSchema
...
from noco_db_python_sdk.type.filter_req import FilterReq
...
from noco_db_python_sdk.pydantic.filter import Filter as FilterPydantic
from noco_db_python_sdk.pydantic.id import Id as IdPydantic
from noco_db_python_sdk.pydantic.filter_req import FilterReq as FilterReqPydantic
...
# Path params
HookIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'hookId': typing.Union[IdSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FilterReqSchema


request_body_filter_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_filter_mapped_args(
        self,
        hook_id: Id,
        comparison_op: typing.Optional[typing.Optional[str]] = None,
        comparison_sub_op: typing.Optional[typing.Optional[str]] = None,
        fk_column_id: typing.Optional[StringOrNull] = None,
        fk_parent_id: typing.Optional[StringOrNull] = None,
        is_group: typing.Optional[ModelBool] = None,
        logical_op: typing.Optional[str] = None,
        ...
        if comparison_op is not None:
            _body["comparison_op"] = comparison_op
        if comparison_sub_op is not None:
            _body["comparison_sub_op"] = comparison_sub_op
        if fk_column_id is not None:
            _body["fk_column_id"] = fk_column_id
        if fk_parent_id is not None:
            _body["fk_parent_id"] = fk_parent_id
        if is_group is not None:
            _body["is_group"] = is_group
        if logical_op is not None:
            _body["logical_op"] = logical_op
    ...
    async def _acreate_new_filter_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/hooks/{hookId}/filters',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_filter_req.serialize(body, content_type)
...
class CreateNewFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_filter(
        self,
        hook_id: Id,
        comparison_op: typing.Optional[typing.Optional[str]] = None,
        comparison_sub_op: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_filter_mapped_args(
            hook_id=hook_id,
        ...
        return await self._acreate_new_filter_oapg(
            body=args.body,
    ...
    def create_new_filter(
        ...
        return self._create_new_filter_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateNewFilter(BaseApi):
    ...
    async def acreate_new_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_filter(
            hook_id=hook_id,
            comparison_op=comparison_op,
            comparison_sub_op=comparison_sub_op,
            fk_column_id=fk_column_id,
    ...
    def create_new_filter(
        ...
        raw_response = self.raw.create_new_filter(
            hook_id=hook_id,
            comparison_op=comparison_op,
            comparison_sub_op=comparison_sub_op,
            fk_column_id=fk_column_id,
