...
from noco_db_python_sdk.model.comment_req import CommentReq as CommentReqSchema

from noco_db_python_sdk.type.audit import Audit
from noco_db_python_sdk.type.comment_req import CommentReq
from noco_db_python_sdk.type.auth_list_base_users400_response import AuthListBaseUsers400Response

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.comment_req import CommentReq as CommentReqPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CommentReqSchema


request_body_comment_req = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_comment_row_mapped_args(
        self,
        fk_model_id: str,
        row_id: str,
    ...
    async def _acreate_new_comment_row_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_comment_req.serialize(body, content_type)
    ...
    def _create_new_comment_row_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewCommentRowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_comment_row(
        self,
        fk_model_id: str,
        row_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_comment_row_mapped_args(
            fk_model_id=fk_model_id,
            row_id=row_id,
            description=description,
            xc_auth=xc_auth,
        )
        return await self._acreate_new_comment_row_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_new_comment_row(
        self,
        fk_model_id: str,
        row_id: str,
        description: typing.Optional[str] = None,
        ...
        return self._create_new_comment_row_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateNewCommentRow(BaseApi):
    ...
    async def acreate_new_comment_row(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_comment_row(
            fk_model_id=fk_model_id,
            row_id=row_id,
            description=description,
            xc_auth=xc_auth,
    ...
    def create_new_comment_row(
        ...
        raw_response = self.raw.create_new_comment_row(
            fk_model_id=fk_model_id,
            row_id=row_id,
            description=description,
            xc_auth=xc_auth,
