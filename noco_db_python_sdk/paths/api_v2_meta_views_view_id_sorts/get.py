...
from noco_db_python_sdk.model.sort_list import SortList as SortListSchema
...
from noco_db_python_sdk.type.sort_list import SortList

from ...api_client import Dictionary
from noco_db_python_sdk.pydantic.sort_list import SortList as SortListPydantic
...
SchemaFor200ResponseBodyApplicationJson = SortListSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_all_sorts_mapped_args(
        self,
        view_id: str,
    ...
    async def _aget_all_sorts_oapg(
        self,
...
class GetAllSortsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_sorts(
        self,
        view_id: str,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_all_sorts_mapped_args(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        return await self._aget_all_sorts_oapg(
    ...
    def get_all_sorts(
        ...
        return self._get_all_sorts_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetAllSorts(BaseApi):
    ...
    async def aget_all_sorts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_sorts(
            view_id=view_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return SortListPydantic(**raw_response.body)
        return api_client.construct_model_instance(SortListPydantic, raw_response.body)
    ...
    def get_all_sorts(
        ...
        raw_response = self.raw.get_all_sorts(
            view_id=view_id,
            xc_auth=xc_auth,
        )
        if validate:
