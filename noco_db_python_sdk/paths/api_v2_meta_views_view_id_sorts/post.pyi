...
from noco_db_python_sdk.model.db_table_sort_update_view_sort_request import DbTableSortUpdateViewSortRequest as DbTableSortUpdateViewSortRequestSchema
...
from noco_db_python_sdk.type.db_table_sort_update_view_sort_request import DbTableSortUpdateViewSortRequest
...
from noco_db_python_sdk.pydantic.db_table_sort_update_view_sort_request import DbTableSortUpdateViewSortRequest as DbTableSortUpdateViewSortRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DbTableSortUpdateViewSortRequestSchema


request_body_db_table_sort_update_view_sort_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_view_sort_mapped_args(
        self,
        view_id: str,
        fk_column_id: typing.Optional[Id] = None,
        direction: typing.Optional[str] = None,
        push_to_top: typing.Optional[bool] = None,
        ...
        if push_to_top is not None:
            _body["push_to_top"] = push_to_top
        args.body = _body
    ...
    async def _aupdate_view_sort_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/views/{viewId}/sorts',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_db_table_sort_update_view_sort_request.serialize(body, content_type)
...
class UpdateViewSortRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_view_sort(
        self,
        view_id: str,
        fk_column_id: typing.Optional[Id] = None,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_view_sort_mapped_args(
            body=body,
            view_id=view_id,
        ...
        return await self._aupdate_view_sort_oapg(
            body=args.body,
    ...
    def update_view_sort(
        ...
        return self._update_view_sort_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateViewSort(BaseApi):
    ...
    async def aupdate_view_sort(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_view_sort(
            body=body,
            view_id=view_id,
            fk_column_id=fk_column_id,
            direction=direction,
    ...
    def update_view_sort(
        ...
        raw_response = self.raw.update_view_sort(
            body=body,
            view_id=view_id,
            fk_column_id=fk_column_id,
            direction=direction,
