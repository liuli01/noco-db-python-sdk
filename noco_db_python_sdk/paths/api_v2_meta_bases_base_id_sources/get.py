...
from noco_db_python_sdk.model.source_list import SourceList as SourceListSchema
...
from noco_db_python_sdk.type.source_list import SourceList
...
from noco_db_python_sdk.pydantic.source_list import SourceList as SourceListPydantic
...
SchemaFor200ResponseBodyApplicationJson = SourceListSchema
...
class BaseApi(api_client.Api):
    ...
    def _base_id_sources_list_mapped_args(
        self,
        base_id: Id,
    ...
    async def _abase_id_sources_list_oapg(
        self,
    ...
    def _base_id_sources_list_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BaseIdSourcesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abase_id_sources_list(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._base_id_sources_list_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._abase_id_sources_list_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def base_id_sources_list(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._base_id_sources_list_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BaseIdSourcesList(BaseApi):
    ...
    async def abase_id_sources_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abase_id_sources_list(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
        if validate:
            return RootModel[SourceList](raw_response.body).root
    ...
    def base_id_sources_list(
        ...
        raw_response = self.raw.base_id_sources_list(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
