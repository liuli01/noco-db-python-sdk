...
class BaseApi(api_client.Api):
    ...
    def _check_empty_filters_mapped_args(
        self,
        base_id: Id,
    ...
    async def _acheck_empty_filters_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/meta/bases/{baseId}/has-empty-or-null-filters',
            headers=_headers,
        )
...
class CheckEmptyFiltersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_empty_filters(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._check_empty_filters_mapped_args(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        return await self._acheck_empty_filters_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def check_empty_filters(
        self,
        base_id: Id,
        xc_auth: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._check_empty_filters_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CheckEmptyFilters(BaseApi):
    ...
    async def acheck_empty_filters(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_empty_filters(
            base_id=base_id,
            xc_auth=xc_auth,
            **kwargs,
        )
    ...
    def check_empty_filters(
        ...
        raw_response = self.raw.check_empty_filters(
            base_id=base_id,
            xc_auth=xc_auth,
        )
        if validate:
