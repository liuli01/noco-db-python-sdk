...
class SourceGetMetaDiffResponseItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def detectedChanges() -> typing.Type['SourceGetMetaDiffResponseItemDetectedChanges']:
                return SourceGetMetaDiffResponseItemDetectedChanges
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["detectedChanges"]) -> 'SourceGetMetaDiffResponseItemDetectedChanges': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["detectedChanges"]) -> typing.Union['SourceGetMetaDiffResponseItemDetectedChanges', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        detectedChanges: typing.Union['SourceGetMetaDiffResponseItemDetectedChanges', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SourceGetMetaDiffResponseItem':
