...
class KanbanUpdateReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fk_grp_col_id", "fk_cover_image_col_id", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fk_grp_col_id", "fk_cover_image_col_id", "meta", ], str]):
