...
class TableEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def body() -> typing.Type['TableEventBody']:
                return TableEventBody
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["body"]) -> 'TableEventBody': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["body"]) -> 'TableEventBody': ...
