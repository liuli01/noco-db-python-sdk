...
class HookTestReq(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hook"]) -> 'HookReq': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hook", "payload", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hook"]) -> 'HookReq': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hook", "payload", ], str]):
