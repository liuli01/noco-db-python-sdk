...
class AttachmentReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "mimetype", "path", "size", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "mimetype", "path", "size", "url", ], str]):
