...
class ViewEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def body() -> typing.Type['ViewEventBody']:
                return ViewEventBody
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["body"]) -> 'ViewEventBody': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["body"]) -> 'ViewEventBody': ...
