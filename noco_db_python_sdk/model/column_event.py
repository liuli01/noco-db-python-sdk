...
class ColumnEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def body() -> typing.Type['ColumnEventBody']:
                return ColumnEventBody
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["body"]) -> 'ColumnEventBody': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["body"]) -> 'ColumnEventBody': ...
