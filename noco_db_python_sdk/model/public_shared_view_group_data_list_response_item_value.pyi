...
class PublicSharedViewGroupDataListResponseItemValue(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _list() -> typing.Type['PublicSharedViewGroupDataListResponseItemValueList']:
                return PublicSharedViewGroupDataListResponseItemValueList
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["list"]) -> 'PublicSharedViewGroupDataListResponseItemValueList': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["list"]) -> 'PublicSharedViewGroupDataListResponseItemValueList': ...
    ...
    ) -> 'PublicSharedViewGroupDataListResponseItemValue':
