...
class BaseDuplicatePostRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['BaseDuplicatePostRequestOptions']:
                return BaseDuplicatePostRequestOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'BaseDuplicatePostRequestOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['BaseDuplicatePostRequestOptions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        options: typing.Union['BaseDuplicatePostRequestOptions', schemas.Unset] = schemas.unset,
