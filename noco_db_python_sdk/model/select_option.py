...
class SelectOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "fk_column_id", "color", "order", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "fk_column_id", "color", "order", ], str]):
