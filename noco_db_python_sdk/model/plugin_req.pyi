...
class PluginReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["active", "input", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["active", "input", ], str]):
