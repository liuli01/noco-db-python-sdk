...
from noco_db_python_sdk.exceptions_base import ApiValueError
from noco_db_python_sdk.exceptions import ClientConfigurationError
from noco_db_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = noco_db_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
                 ...
                 discard_unknown_keys=False,
                                  xc_auth=None,
                                  xc_shared_base_id=None,
                                  xc_shared_erd_id=None,
        ...
        self.api_key = {}
        if xc_auth:
            self.api_key['xc-auth'] = xc_auth
        if xc_shared_base_id:
            self.api_key['xc-shared-base-id'] = xc_shared_base_id
        if xc_shared_erd_id:
            self.api_key['xc-shared-erd-id'] = xc_shared_erd_id
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("noco_db_python_sdk")
    ...
    def auth_settings(self):
        ...
        if 'xc-shared-base-id' in self.api_key:
            auth['xc-shared-base-id'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Shared Base ID',
                'value': self.get_api_key_with_prefix(
        ...
        if 'xc-shared-erd-id' in self.api_key:
            auth['xc-shared-erd-id'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Shared ERD ID',
                'value': self.get_api_key_with_prefix(
